        ...
        {a?.map((data) => {
          return (
            <div className='grid-item'>
              <h1 style={{fontSize:'26px', fontFamily: 'Rubik !important', fontWeight: 600, color: 'black', margin:0}}><b>AESOP</b></h1>
              <h4 style={{fontSize:'36px', color: 'black', margin:0}}>TERMINAL</h4>
              <h1 style={{fontSize:'26px', fontFamily: 'Rubik !important', fontWeight: 600, color: 'black', margin:0}}>OFF WHITE</h1>
              <hr />
              <div className='d-flex'>
                ...
                <div>
                  <h4 className='text-center m-0' style={{ width: '50px' }}>:</h4>
                  <h4 className='text-center m-0' style={{ width: '50px' }}>:</h4>
                  <h4 className='text-center m-0' style={{ width: '50px' }}>:</h4>
                </div>
                <div>
