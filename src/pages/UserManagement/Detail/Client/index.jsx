...
import '../index.scss';
import { onClientStatusClick,
         onEnabledAllClient, } from '../service';
        ...
        <div className={`flex-column line-border my-3 `}>
            <div className={`d-flex `}>
                ...
                <div className="col-6 client-enableall-padding">
                    <button 
                        type="button" 
                        className={`btn float-right px-1 mb-2 ${isEnableAllClient ? 'btn-outline-All-notActive' : 'btn-outline-All-active'} `} 
                        ...
                        <div className="d-flex mb-1" key={index}>
                            ...
                            <div className="col-6">
                                <button 
                                    ...
                                    onClick={(e) => { onClientStatusClick({e, index, state, setState }); }}>
