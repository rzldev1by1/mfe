    ...
    loginForm(errorMessage, formValidation) {
        return (
            <form className={"mt-3 " + (this.state.forgotPassword ? 'form-hidden' : 'form-show')} onSubmit={this.validateForm}>
                ...
                <div className="row">
                    <div className="pl-3 pr-0" style={{width:'max-content'}}>
        ...
        return (
            <div className='privacy-and-term mb-3'>
                ...
                <div className='form-control text-area-policy inputLogin'>
                    ...
                    mail, email, and street addresses;<br/>

                    telephone and facsimile numbers;<br/>

                    profession, occupation, job title, and work history;<br/>

                    bank details;<br/>

                    photos and videos;<br/>

                    details of the products and services you have purchased from us, or which you have enquired about, together with any additional information necessary to deliver those products and services, respond to your enquiries and generally to complete any commercial transaction between you and us;<br/>

                    any additional information relating to you that you provide to us directly through our websites or indirectly through use of our websites or online presence, through our representatives or otherwise; and<br/>

                    information you provide to us through our service center, customer surveys and/or visits by, or telephone calls from, our representatives from time to time.<br/>

                    We do not ordinarily collect sensitive information as defined in the Privacy Act or the GDPR.<br/>
                    We may also collect some information that is not personal information because it does not identify you or anyone else. For example, we may collect anonymous answers to surveys or aggregated information about how users use our website.<br/>
                    How do we collect personal information?<br/>
                    To the extent legally permissible in your jurisdiction, Microlistics collects personal information in a number of ways, including:
                    ...
                    from our own records of how you use Microlistics services.
                    ...
                    fulfil the administrative, planning, quality control, and research purposes of Microlistics, its related bodies corporate, contractors, and/or suppliers;
                    ...
                    Cookie usage
                    Cookies are small files which are stored on a user’s computer. They are designed to hold a modest amount of data specific to a particular client and website.  They can be accessed either by the web server or the client computer.
                    ...
                    We also use remarketing tools such as Google Adwords and Analytics to display content-specific advertisements to visitors who have previously visited our site when those visitors go to other websites that have implemented the Google Display Network.
                    Microlistics and other third-party vendors, including Google, use first-party cookies (such as the Google Analytics cookie) and third-party cookies (such as the DoubleClick cookie) together to inform, optimize, and serve ads based on visitors’ past visits to our website.
                    ...
                    For the purposes set out above (under “How do we use your personal information”) we may disclose your personal information to organizations or persons outside Microlistics, to the extent this is legally permissible in your jurisdiction. If we need to disclose your personal information for any other purpose, we will only do so with your consent or—if this is legally permissible in your jurisdiction—where you may otherwise reasonably expect us to do so.
                    ...
                    Email: privacyofficer@wisetechglobal.com
                    Post: Unit 3a, 72 O’Riordan Street, Alexandria NSW 2015 Australia.
                    If you do make a complaint or allege a breach, WTG will investigate your complaint and use reasonable endeavours to respond to you in writing within 28 days of receiving the written complaint. If we fail to respond to your complaint within 28 days of receiving it in writing, or if you are dissatisfied with the response that you receive from us, you have the right, depending on the jurisdiction, to make a complaint to the applicable regulator. In the case of the Privacy Act, the applicable regulator is the Office of the Australian Information Commissioner. In the case of the GDPR, the applicable regulator will be the local regulator in your jurisdiction in Europe.
