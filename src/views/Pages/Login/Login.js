										...
										<div className="col-md-5 col-sm-12 col-lg-4 fullscreen-left pl-0 pr-0">
											<Card className="border-0" style={{ height: '100%' }}>
													<CardBody>
															...
															<form className="mt-5" style={{bottom:"0", height:"100%"}} ref={this.loginForm} onSubmit={e => { e.preventDefault() ; this.authenticateUser() }}>
																	...
																	<InputGroup className="mb-4">
																		<input type="text" className={"form-control input" + (this.state.valid.username.isValid ? "" : " is-invalid")} id="username" name="username" onChange={this.validateForm} autoComplete="off" />
