                    ...
                    <CardBody>
                        ...
                        <div className="system mt-4">
                            ...
                            <div className="row mb-2">
                                ...
                                <div className="col-1 p-0">
                                    <span className='p-1 m-2 client-notActive'>Disable</span>
                                </div>
                                <div className="col-1">
                        ...
                        <div className="user-status mt-4">
                            <div className="row">
                              <div className="col-12">
                                <h3>
                                  <label className="text-bolder">User</label>
                                </h3>
                              </div>
                            </div>
                            <div className="row">
                            ...
                            <div className="row">
                                    ...
                                    <div className="col-4">
                                    <span className='p-1 m-2 client-active'>Reset</span>
                                    </div>
                                    <div className="col-4">
