...
class ListOrderComponent extends Component {
  constructor(props) {
    ...
    this.state = {
      data: [],
      tableheader: [
        "Site", "Client", "Order No", "Order Type", "Customer","Status","Delivery Date",
        "Date Received","Date Released","Date Completed","Customer Po No","Vendor Order No" ,
        "Address 1","Address 2","Address 3","Address 4","Address 5","Suburb","Post Code","state",
        "Country"
      ],
