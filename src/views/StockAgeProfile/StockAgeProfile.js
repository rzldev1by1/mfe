...
class StockAgeProfile extends Component {
    ...
    changeStartIndex = (currentPage) => {
        this.setState({
            startIndex: (parseInt(currentPage) * this.state.displayPage) - this.state.displayPage
        });
    }
    ...
    render() {
        ...
        content = <Table
            ...
            <tbody>
                {JSON
                    .parse(localStorage.getItem('cachedData'))
                    .map((item, idx) => (
                        <tr key={idx}>
                            {this
                                .state
                                ...
                                .map((column, columnIdx) => {
                                    if (column.id === "site" || column.id === "productId" || column.id === "description" || column.id === "uom") {
                                                                        ...
                                                                        <div className="input-group p-2">
                                                                            <div className="input-group-prepend bg-white col-9">
                                                                                <span className="input-group-text border-0 bg-white p-0">
                                                                                    <i className="fa fa-search fa-2x iconSpace"/> {/* <i className="iconU-search" /> */}
                                                                                </span>
                                                                                <input
                                                                                    type="text"
                                                                                    className="form-control border-0 pt-2"
                                                                                    id="searchForm"
                                                                                    name="searchForm"
                                                                            ...
                                                                            <div className="col-3 text-right">
                                                                                <Button
                                                                                    className={"circle" + (this.state.showFilter
                                                                                    ? " active"
                                                                                    : "")}
                                                                                    onClick={this.triggerShowFilter}>
