        ...
        <div className="line">
          <table className="tabledetails">
              <tr>
                ...
                <th className='required-field' style={{width:"5%", paddingLeft:"5px"}}>Qty</th>
                ...
                <th style={{width:"6%", paddingLeft:"2px"}}>Batch</th>
                <th style={{width:"5%", paddingLeft:"1px"}}>Ref3</th>
                <th style={{width:"5%", paddingLeft:"1px"}}>Ref4</th>
              ...
              <Modal className="POCreate" isOpen={this.props.showmodal} modalTransition={{ timeout: 700 }} backdropTransition={{ timeout: 800 }}toggle={true} >
                <div className="createModal">
                  ...
                  <ModalHeader className="Tabs" style={{marginTop:"-40px"}} >
                        <div>
                          <div className="createdec" style={{marginLeft:"36px"}}>
