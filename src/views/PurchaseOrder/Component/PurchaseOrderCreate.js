...
class PurchaseOrderCreate extends Component {
  ...
  getsupplier = () => {
    axios
      .get(endpoint.getSupplier + "?client=" + headers.client, {
        headers: headers
      })
      .then((res) => {
        const result = res.data;
  ...
  getuom = (i, value) => {
    axios
      .get(
        endpoint.getUom + "?client=" + headers.client + "&product=" + value,
        {
          headers: headers
        }
      )
    ...
    return (
      <div className="tabcontent">
        ...
        <table className="createpotable">
          <tr>
            <th className="required-field" style={{ width: "396px" }}>
              Site
            </th>
            <th className="required-field" style={{ width: "396px" }}>
              Client
          ...
          <tr>
            ...
            <td>
              <DatePicker
                style={{ minWidth: "22%", position: "absolute" }}
                getDate={(e) => {
                  this.setState({ orderDate: e });
                  this.state.rowlist[0].orderDate = e;
                }}
            ...
            <td>
              <input
                className="form2 put pec"
                value={this.state.vendorRef}
                placeholder="Vendor Order Ref"
                onChange={(e) => this.setState({ vendorRef: e.target.value })}
                maxLength="40"
              />{" "}
            </td>
          </tr>
        ...
        <div className="line">
          <table className="tabledetails">
            <tr>
              ...
              <th className="required-field" style={{ width: "12%" }}>
                Product
              </th>
              <th className="required-field" style={{ width: "12%" }}>
                Product Description
              </th>
              <th className="required-field" style={{ width: "5%" }}>
                Qty
              </th>
              <th className="required-field" style={{ width: "6%" }}>
                UOM
              </th>
        ...
        <div
          className={
            "tablerow " + (this.state.rowlist.length > 2 ? "scroll" : null)
          }
          style={{ width: "98%" }}
        >
        ...
        <button
          ...
          type="button"
          className="btn btn-light font addline"
        >
          + Add Line
        </button>
    ...
    return (
      <div className="tabcontent fades">
        ...
        <table className="createpotable">
          ...
          <tr>
            ...
            <td>
              <input
                className="form-control"
                value={moment(this.state.orderDate).format("DD MMMM YYYY")}
                readOnly
              />
            </td>
            <td>
        ...
        <table className="tabledetails">
          <tr>
            <th
              style={{ width: "2%", textAlign: "center", paddingLeft: "18px" }}
            >
              #
            </th>
            <th style={{ width: "12%", paddingLeft: "20px" }}>Product</th>
            <th style={{ width: "12%", paddingLeft: "24px" }}>
              Product Description
            </th>
    ...
    return (
      <table>
        <tr>
          ...
          <td style={{ width: "3.5%", textAlign: "center" }}>
            <input
          ...
          {console.log(self.state.rowlist[i].product)}
          <td style={{ width: "12%" }}>
            <input
              className="form-control inputs pec"
              placeholder="Product"
              ...
              onChange={(e) => {
                self.state.rowlist[i].product = e.target.value;
                this.getuom(i, e.target.value);
              }}
            />
          </td>
          <td style={{ width: "12%" }}>
            <input
              ...
              defaultValue={self.state.rowlist[i].productDescription}
              onChange={(e) =>
                (self.state.rowlist[i].productDescription = e.target.value)
              }
            />
          </td>
          <td style={{ width: "4.5%" }}>
            <input
              ...
              className="form-control inputs pec"
              placeholder="Qty"
              defaultValue={self.state.rowlist[i].qty}
              onChange={(e) => (self.state.rowlist[i].qty = e.target.value)}
            />
          </td>
          <td style={{ width: "6%" }}>
            <Dropdown
          ...
          <td style={{ width: "11%" }}>
            <DatePicker
              style={{ minWidth: "100%" }}
              field="smallField"
              getDate={(e) => (self.state.rowlist[i].rotadate = e)}
              defaultValue={self.state.rowlist[i].rotadate}
            />{" "}
          </td>
          <td style={{ width: "6%" }}>
            <input
              ...
              placeholder="Batch"
              maxLength="30"
              defaultValue={self.state.rowlist[i].batch}
              onChange={(e) => (self.state.rowlist[i].batch = e.target.value)}
            />
          </td>
          <td style={{ width: "5%" }}>
            <input
              ...
              placeholder="Ref3"
              maxLength="30"
              defaultValue={self.state.rowlist[i].ref3}
              onChange={(e) => (self.state.rowlist[i].ref3 = e.target.value)}
            />
          </td>
          <td style={{ width: "5%" }}>
            <input
              ...
              placeholder="Ref4"
              maxLength="30"
              defaultValue={self.state.rowlist[i].ref4}
              onChange={(e) => (self.state.rowlist[i].ref4 = e.target.value)}
            />
          </td>
          <td style={{ width: "6.5%" }}>
            <Dropdown
          ...
          <td
            id={list.lineNumber}
            onClick={(e) => this.deletelinehandler(e)}
            style={{ width: "1.5%" }}
          >
            <div className="iconU-delete" />
          </td>
        </tr>
        <td></td>
        <td></td>
        ...
        <td></td>
        <td>
          {this.state.showdaterote ? (
            <DatePicker getChosenDay={(day) => this.datePickerRote(day)} />
          ) : null}
        </td>
      ...
      <table>
        <tr>
          ...
          <td style={{ width: "6.5%" }}>
            <input
              className="form-control inputs pec"
              value={moment(list.rotadate).format("DD MMMM YYYY")}
              readOnly
            />
          </td>
          <td style={{ width: "6%" }}>
  ...
  createPO = () => {
    ...
    axios
      .post(endpoint.purchaseOrderCreate, param, { headers: headers })
      .then((res) => {
    ...
    return (
      <React.Fragment>
        <Button
          onClick={() => this.tabhandler()}
          color="primary"
          className="btnsearch back"
        >
          <label className="font">Back</label>
        </Button>
        <Button
          onClick={() => this.saveclick()}
          color="primary"
          className="btnsearch submit btnleft"
          style={{ marginTop: "-50px" }}
        >
          <i
            className={
              this.state.isSaveProgressing
                ? "mr-2 fa fa-refresh fa-spin "
                : "fa fa-refresh fa-spin d-none"
            }
          ></i>
            ...
            <div>
              ...
              <div className="tabs font">
                <div
                  ...
                  onClick={() => this.tabhandler()}
                  className={
                    "tab1 " + (this.state.tab1isactive ? "tabisactive" : null)
                  }
                >
                  <img
                    className="numberimg"
                ...
                <div
                  ...
                  className={
                    "tab2 tab-review " +
                    (this.state.tab2isactive ? "tabisactive" : null)
                  }
                >
                  <img
                    className="numberimg "
                    style={{ width: "22%" }}
                    src={this.state.tab2isactive ? twoactive : twoinactive}
                  />{" "}
                  Review
                </div>
              </div>
