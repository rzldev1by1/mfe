	...
	constructor(props) {
		...
		this.state = {
			...
			columns: [
				...
				{ id: "expected_out_qty", checkboxLabelText: "Expected Out Qty", tableHeaderText: "Expected Out Qty",width:"7%", isVisible: true, key: "expected_out_wgt", type: "number", sort: mid },
