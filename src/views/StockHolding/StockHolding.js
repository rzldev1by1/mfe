...
class StockHolding extends Component {
	constructor(props) {
		...
		this.state = {
			...
			columns: [
				{ id: "site", checkboxLabelText: "Site", tableHeaderText: "Site", isVisible: true, key: "site",type: "string",style:{width:"4%"},alignText:"text-left",  sort: mid },
				{ id: "client", checkboxLabelText: "Client", tableHeaderText: "Client", isVisible: true, key: "client",type: "string",style:{width:"5%"},alignText:"text-left", sort: mid },
				{ id: "product", checkboxLabelText: "Product", tableHeaderText: "Product", isVisible: true, key: "product", type: "string",style:{width:"5%"},alignText:"text-left", sort: mid },
				{ id: "product_name", checkboxLabelText: "Description", tableHeaderText: "Description", isVisible: true, key: "product_name", type: "string",style:{width:"10%"},alignText:"text-left", sort: mid },
				{ id: "disposition", checkboxLabelText: "Disposition", tableHeaderText: "Disposition", isVisible: false, key: "disposition",type: "string",style:{width:"5%"},alignText:"text-left", sort: mid },
				{ id: "uom", checkboxLabelText: "UOM", tableHeaderText: "UOM", isVisible: true, key: "packdesc_1", type: "string",style:{width:"5%"},alignText:"text-left", sort: mid },
				{ id: "status", checkboxLabelText: "Status", tableHeaderText: "Status", isVisible: true, key: "status", type: "string",style:{width:"5%"},alignText:"text-left", sort: mid },
				{ id: "on_hand_qty", checkboxLabelText: "Stock On Hand", tableHeaderText: "Stock On Hand", isVisible: true, key: "on_hand_qty",type: "number",style:{width:"10%"},alignText:"text-right pr-4", sort: mid },
				{ id: "weight", checkboxLabelText: "On Hand Wgt", tableHeaderText: "On Hand Weight", isVisible: true, key: "weight", type: "number",style:{width:"10%"},alignText:"text-right pr-4", sort: mid },
				{ id: "expected_in_qty", checkboxLabelText: "Expected In Qty", tableHeaderText: "Expected In Qty", isVisible: true, key: "expected_in_qty",type: "number",style:{width:"10%"},alignText:"text-right pr-4", sort: mid },
				{ id: "expected_in_wgt", checkboxLabelText: "Expected In Wgt", tableHeaderText: "Expected In Weight", isVisible: true, key: "expected_in_wgt", type: "number",style:{width:"10%"},alignText:"text-right pr-4", sort: mid },
				{ id: "expected_out_qty", checkboxLabelText: "Expected Out Qty", tableHeaderText: "Expected Out Qty", isVisible: true, key: "expected_out_qty", type: "number",style:{width:"10%"},alignText:"text-right pr-4", sort: mid },
				{ id: "price", checkboxLabelText: "Price", tableHeaderText: "Price", isVisible: false, key: "price", type: "number",style:{width:"5%"},alignText:"text-right pr-4", sort: mid },
				{ id: "pallets", checkboxLabelText: "Pallets", tableHeaderText: "Pallets", isVisible: false, key: "pallet",type: "string",style:{width:"5%"},alignText:"text-left", sort: mid },
			],
			masterSite: [],
