...
class StockHolding extends Component {
	constructor(props) {
		...
		this.state = {
			...
			columns: [
                { id: "site", checkboxLabelText: "Site", tableHeaderText: "Site",width:"7%", isVisible: true, key: "site", type: "string", sort: mid },
                { id: "client", checkboxLabelText: "Client", tableHeaderText: "Client",width:"7%", isVisible: true, key: "client", type: "string", sort: mid },
				{ id: "product", checkboxLabelText: "Product", tableHeaderText: "Product",width:"15%", isVisible: true, key: "product", type: "string", sort: mid },
				{ id: "description", checkboxLabelText: "Description", tableHeaderText: "Description",width:"35%", isVisible: true, key: "product_name", type: "string", sort: mid },
				{ id: "disposition", checkboxLabelText: "Disposition", tableHeaderText: "Disposition",width:"7%", isVisible: false, key: "disposition", type: "string", sort: mid },
				{ id: "uom", checkboxLabelText: "UOM", tableHeaderText: "UOM",width:"7%", isVisible: true, key: "packdesc_1", type: "string", sort: mid },
				{ id: "status", checkboxLabelText: "Status", tableHeaderText: "Status",width:"7%", isVisible: true, key: "status", type: "string", sort: mid },
				{ id: "on_hand_qty", checkboxLabelText: "On Hand Qty", tableHeaderText: "On Hand Qty",width:"5%", isVisible: true, key: "on_hand_qty", type: "number", sort: mid },
				{ id: "on_hand_weight", checkboxLabelText: "On Hand Wgt", tableHeaderText: "On Hand Weight",width:"5%", isVisible: true, key: "weight", type: "number", sort: mid },
				{ id: "expected_in_qty", checkboxLabelText: "Expected In Qty", tableHeaderText: "Expected In Qty",width:"5%", isVisible: true, key: "expected_in_qty", type: "number", sort: mid },
				{ id: "expected_in_weight", checkboxLabelText: "Expected In Wgt", tableHeaderText: "Expected In Weight",width:"7%", isVisible: true, key: "expected_in_wgt", type: "number", sort: mid },
				{ id: "expected_out_qty", checkboxLabelText: "Expected Out Qty", tableHeaderText: "Expected Out Qty",width:"7%", isVisible: true, key: "expected_out_qty", type: "number", sort: mid },
				{ id: "price", checkboxLabelText: "Price", tableHeaderText: "Price",width:"7%", isVisible: false, key: "price", type: "number", sort: mid },
				{ id: "pallets", checkboxLabelText: "Pallets", tableHeaderText: "Pallets",width:"7%", isVisible: false, key: "pallet", type: "string", sort: mid },
            ],
            masterSite: [],
