...
class StockHolding extends Component {
	constructor(props) {
		...
		this.state = {
			...
			columns: [
				{ id: "site", checkboxLabelText: "Site", tableHeaderText: "Site", isVisible: true, key: "site",width:'5%', type: "string", sort: mid },
				{ id: "client", checkboxLabelText: "Client", tableHeaderText: "Client", isVisible: true, key: "client",width:'5%', type: "string", sort: mid },
				{ id: "product", checkboxLabelText: "Product", tableHeaderText: "Product", isVisible: true, key: "product",width:'15%', type: "string", sort: mid },
				{ id: "product_name", checkboxLabelText: "Description", tableHeaderText: "Description", isVisible: true, key: "product_name",width:'25%', type: "string", sort: mid },
				...
				{ id: "expected_out_qty", checkboxLabelText: "Expected Out Qty", tableHeaderText: "Expected Out Qty", isVisible: true, key: "expected_out_qty",width:'5%', type: "number", sort: mid },
				{ id: "price", checkboxLabelText: "Price", tableHeaderText: "Price", isVisible: false, key: "price",width:'5%', type: "number", sort: mid },
				{ id: "pallets", checkboxLabelText: "Pallets", tableHeaderText: "Pallets", isVisible: false, key: "pallet",width:'5%', type: "string", sort: mid },
			],
			masterSite: [],
